...
class FourWheelCarSupervisor(CSVSupervisorEnv):
    ...
    def __init__(self):
        ...
        self.previous_distance_to_target = 2.733
        self.is_done_steps = 0
    ...
    def get_observations(self):
        ...
        # The parameter from robot (robot_super.py)
        ...
        #robot yaw angle
        robot_angle_norm = round(normalize_to_range(float(robot_angle), -3.14, 3.14, -1.0, 1.0), 2)
        ...
        # if self.message_received[9] == 'True':
        #     box_detected = 1.0
        # else:
        #     box_detected = 0.0
        ...
        # print(distance_sensor_norm, steer_left_pos_norm, front_left_wheel_norm, distance_r_tar_norm, distance_r_obs_norm, self.lanes_input[0], self.lanes_input[1], self.lanes_input[2], detected, robot_angle_norm)
        ...
        # return [steer_left_pos_norm, front_left_wheel_norm, distance_r_tar_norm, distance_r_obs_norm, self.lanes_input[0], self.lanes_input[1], self.lanes_input[2], detected, robot_angle_norm]
    ...
    def get_reward(self, action=None):
        ...
        # target_z_position = round(self.target.getPosition()[2],2)
        ...
        # Initialize previous distance if not exist
        # print(distance_r_tar)
        # print(f'Previous distance - {self.previous_distance_to_target}')
        ...
        if abs(robot_y_position) > 0.43:
            ...
            out_of_road_penalty = min(abs(2.62 - distance_r_tar) * 10, 2)
        ...
        if (robot_x_position >= 2.165 and robot_x_position <= 2.77) and robot_y_position >= 0.06 and not self.hit_the_box:
            hit_box_penalty = 7  
        ...
        # # if distance_r_obs < 0.32 and not self.too_close_box:
        #     # return -2
        #     # self.too_close_box = True
        #     # reward -= 1
    ...
    def is_done(self):
        ...
        if self.is_done_steps == self.steps_per_episode - 1:
            return True
